...
public abstract class ObjectUtil 
{
	...
	private static final int MULTIPLIER = 31; // 增效器
	private static final String EMPTY_STRING = "";//空字符串
	private static final String NULL_STRING = "null";//null字符串
	private static final String ARRAY_START = "{";//数组开始符
	private static final String ARRAY_END = "}";//数组结束符
	private static final String EMPTY_ARRAY = ARRAY_START + ARRAY_END;//空数组
	private static final String ARRAY_ELEMENT_SEPARATOR = ", ";//元素分隔符
	/**
